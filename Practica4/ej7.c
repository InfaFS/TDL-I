...
void listaInvertida(lista *, lista *);
...
int main(){
    ...
    listaInvertida(&l,&listita);
    

   // eliminarTodo(&l);

    printf("Lista invertida: ");
    imprimirLista(listita);
    printf("Tamanio lista inv: %d",tamanio(listita));

    printf("Liberando estructuras.. ");
    eliminarTodo(&l);
    eliminarTodo(&listita);
...
void listaInvertida(lista * l,lista * listita){
    lista aux=*l;

    while (aux!=NULL){
        agregarInicio(listita,aux->dato);
        aux=aux->sig;
    }
